...
namespace Clay.SmartDoor.Infrastructure.UnitOfWork
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        private IDoorAssignmentService _doorAssignments { get; set; } = null!;
        ...
        public IDoorAssignmentService DoorAssignments => _doorAssignments ??= new DoorAssignmentRepository(_smartDoorContext);
