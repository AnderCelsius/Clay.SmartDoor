...
{
    public class SmartDoorJwtService
    {
        public const string JwtScopeApiKey = "ApiKey";
        public const string JwtScopeOrganizationUser = "OrganizationUserApi";
        public const string JwtScopeOrganizationAdmin = "OrganizationAdminApi";
        ...
        public SmartDoorJwtService(IConfiguration configuration)
        {
